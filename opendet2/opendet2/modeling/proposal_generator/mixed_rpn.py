...
class MixedRPNHead(nn.Module):
    ...
    def __init__(
        ...
        # 1x1 conv for predicting centerness; for class agnostic
        self.centerness = nn.Conv2d(cur_channels, num_anchors, kernel_size=1, stride=1)
        # 1x1 conv for predicting objectness logits; for class specific
    ...
    def forward(self, features: List[torch.Tensor]):
        ...
        return pred_anchor_deltas, pred_centerness, pred_objectness_logits


@PROPOSAL_GENERATOR_REGISTRY.register()
class MixedRPN(nn.Module):
    """
    ...
    def forward(
        ...
        pred_anchor_deltas, pred_centerness, pred_objectness_logits = self.rpn_head(features)
