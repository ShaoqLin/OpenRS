...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        test_mode=True,
        type='DOTADataset_test'),
    drop_last=False,
    num_workers=2,
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
test_dataset_type = 'DOTADataset_test'
test_evaluator = dict(metric='mAP', predict_box_type='hbox', type='DOTAMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
        1024,
...
work_dir = './work_dirs/benchmark_faster-rcnn_1gpu_bs4_r50_fpn_2x_lr1e-2_dotav1_0'
